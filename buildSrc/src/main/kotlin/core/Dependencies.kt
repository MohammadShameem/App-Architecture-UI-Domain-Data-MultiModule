...
internal object Dependencies {
    ...
    const val workManger = "androidx.work:work-runtime-ktx:${Versions.worker_version}"
    const val workManagerStarter = "androidx.startup:startup-runtime:${Versions.workManagerStarter}"
    ...
    const val hiltWorker = "androidx.hilt:hilt-work:${Versions.hilt_worker_version}"
    const val hiltWorkerCompiler = "androidx.hilt:hilt-compiler:${Versions.hilt_worker_version}"
    ...
    const val sunmiPrinter = "com.sunmi:printerlibrary:${Versions.sunmi_printer_version}"
