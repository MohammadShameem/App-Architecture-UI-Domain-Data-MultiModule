...
fun DependencyHandler.addHiltWorkerDependencies() {
    add("implementation",Dependencies.hiltWorker)
    add("implementation",Dependencies.workManger)
    add("implementation",Dependencies.workManagerStarter)
    add("kapt",Dependencies.hiltWorkerCompiler)
}
...
fun DependencyHandler.addSunmiPrinterDependencies(){
    add("implementation",Dependencies.sunmiPrinter)
}
